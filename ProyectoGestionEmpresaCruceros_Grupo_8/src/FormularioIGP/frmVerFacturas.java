...
public class frmVerFacturas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmVerFacturas
     */
    ...
    private void cargarJTable(int opcion){
        ...
        facturas = (DefaultTableModel) tablaFacturas.getModel();
        facturas.setRowCount(0);
        try {
            if(opcion == 1){
                ps = dbConnection.dbConexion().prepareStatement("SELECT codigoFactura, CONCAT(nombres, apellidos)nomb, telefono, correoElectronico, bu.nombreBuque, ff.idViaje, "
                ...
                ps = dbConnection.dbConexion().prepareStatement("SELECT codigoFactura, CONCAT(nombres, apellidos)nomb, telefono, correoElectronico, bu.nombreBuque, ff.idViaje, "
                    + "codigoCamarote, subtotal, impuestoPortuario, CONVERT(varchar, ISV), descuento, propina, totalPagar, CONVERT(varchar, fecha, 0)fecha FROM facturaFinal ff " +
                    "INNER JOIN clientes c ON ff.identidadCliente = c.identidadCliente " +
                    "INNER JOIN buques bu ON ff.codigoBuque = bu.codigoBuque WHERE codigoFactura LIKE ? OR c.nombres LIKE ?");
                ps.setString(1, txtBusqueda.getText() + "%");
                ps.setString(2, txtBusqueda.getText() + "%");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVerFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
